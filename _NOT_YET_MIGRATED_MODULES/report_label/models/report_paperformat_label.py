...
class ReportPaperformatLabel(models.Model):
    ...
    #orientation = fields.Selection(default="Portrait") #ADU
    #header_spacing = fields.Integer(default=0) #ADU
    #margin_top = fields.Float(default=7) #ADU
    #margin_bottom = fields.Float(default=7) #ADU
