...
class projectAccountingResPartner(models.Model):
     ...
     is_probono_partner = fields.Boolean('Client probono', company_dependent=True, help="Client pour lequel on réalise des mission pro bono (gratuite). Si cette case est cochée, les projets pour ce client final pourront passer au statut Commandé sans que le montant ne soit renseigné sur la Structure au lancement du projet.")
